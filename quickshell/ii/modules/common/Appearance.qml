...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3background: "#0D0D0F"
        property color m3onBackground: "#F2F2F2"
        property color m3surface: "#111114"
        property color m3surfaceDim: "#141313"
        property color m3surfaceBright: "#3a3939"
        property color m3surfaceContainerLowest: "#09090A"
        property color m3surfaceContainerLow: "#131316"
        property color m3surfaceContainer: "#18181B"
        property color m3surfaceContainerHigh: "#1F1F23"
        property color m3surfaceContainerHighest: "#27272B"
        property color m3onSurface: "#F2F2F2"
        property color m3surfaceVariant: "#49464a"
        property color m3onSurfaceVariant: "#D0D0D0"
        ...
        property color m3surfaceTint: "#9B1127"
        property color m3primary: "#9B1127"
        property color m3onPrimary: "#322f34"
        property color m3primaryContainer: "#5A0A18"
        property color m3onPrimaryContainer: "#bcb6bc"
        property color m3inversePrimary: "#615d63"
        property color m3secondary: "#B21E35"
        property color m3onSecondary: "#323032"
        property color m3secondaryContainer: "#3D0A13"
        property color m3onSecondaryContainer: "#ece6e9"
        property color m3tertiary: "#7F0E1F"
