...
--##! Session
hl.bind("CTRL + L", hl.dsp.exec_cmd("loginctl lock-session"), { description = "Session: Lock" })
...
-- Normal desktop keybinds

hl.bind("ALT + F4", hl.dsp.window.close())
hl.bind("ALT + D", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }))
hl.bind("CTRL + L", hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind("ALT + Up", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }))
hl.bind("ALT + Down", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }))
...
hl.bind("SUPER + A", hl.dsp.exec_cmd("nwg-drawer"))
